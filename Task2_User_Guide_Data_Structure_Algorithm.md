...
> Application of Data Structure and Algorithm: Heap and Heap Sort
...
- The tests are already shown at the end of Task_2_code.py, starting with "# Test for ...". The arrays can be changed to any other arrays. Just copy the code and run them in the IDE. Then the ordered heap will be shown!
